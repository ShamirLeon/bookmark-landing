...
const ExtensionItem = ({ title, description }) => {
	return (
		<>
			...
			<button className='my-4 rounded-md bg-SoftBlue py-3 px-5 text-base font-medium text-white shadow-lg border-[1px] border-SoftBlue/0 hover:border-SoftBlue/100 hover:text-SoftBlue hover:bg-white transition-all'>
