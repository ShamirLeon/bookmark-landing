			...
			<div className='flex flex-col lg:flex-row lg:justify-center'>
				{features.items.map((Feature, index) => (
					<button
						...
						className='after:content-[" "] relative border-b-[1px] border-GrayishBlue/50 py-3  text-DarkBlue transition-colors  after:absolute after:bottom-0 after:right-0 after:left-0 after:mx-auto after:h-1 after:w-[40%] after:bg-SoftRed after:opacity-0 after:transition-all hover:text-SoftRed focus:after:opacity-100 lg:px-14 lg:after:w-[100%]'
					>
						{Feature.head}
					</button>
				))}
