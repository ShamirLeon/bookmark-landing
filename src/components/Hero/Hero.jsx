		...
		<main className='my-8 flex-row-reverse items-center justify-around lg:flex lg:gap-12 lg:px-32'>
			...
			<div className='flex flex-col gap-5 px-7 text-center lg:max-w-[500px] lg:px-0 lg:text-left'>
				...
				<div className='my-8'>
					<a
						href='#'
						className='mx-2 rounded-md bg-SoftBlue py-3 px-3 text-sm font-medium text-white shadow-lg lg:mx-0 border-[1px] border-SoftBlue/0 hover:border-SoftBlue/100 hover:bg-white hover:text-SoftBlue transition-all'
					>
						Get it on Chrome
					</a>
					...
					<a
						href='#'
						className='mx-2 rounded-md py-3 px-3 text-sm font-medium text-GrayishBlue shadow-lg lg:mx-5 border-[1px] border-black/0 hover:border-black/100 hover:text-black transition-all'
					>
						Get it on firefox
					</a>
				</div>
